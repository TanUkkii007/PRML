...
class Classifier(object):
    ...
    def fit(self, X: np.ndarray, t: np.ndarray, **kwargs):
        """
    ...
    def classify(self, X: np.ndarray, **kwargs):
        """
        classify inputs
        Parameters
        ----------
    ...
    def proba(self, X: np.ndarray, **kwargs) -> np.ndarray:
        """
    ...
    def _check_target(self, t: np.ndarray):
